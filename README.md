...
Walkthrough mode is intentionally not exact line-sync mode. Source line ranges still label each section, but inline hints are disabled and the right panel reads more like a guided technical book.
